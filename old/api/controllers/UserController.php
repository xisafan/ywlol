...
class UserController {
    ...
    public function login($params) {
        ...
        // 更新或插入refresh_token
        $check_sql = "SELECT COUNT(*) FROM " . "qwq_user_token WHERE user_id = :user_id AND device_id = :device_id";
        $stmt = $this->db->prepare($check_sql);
        ...
        try {
            ...
            if ($stmt->fetchColumn() > 0) {
                // 更新refresh_token
                $update_sql = "UPDATE " . "qwq_user_token 
                ...
                // 插入refresh_token
                $insert_sql = "INSERT INTO " . "qwq_user_token 
    ...
    public function addFavorite($user_id, $params) {
        ...
        // 检查是否已收藏
        $check_sql = "SELECT COUNT(*) FROM " . "qwq_favorite WHERE user_id = :user_id AND vod_id = :vod_id";
        $stmt = $this->db->prepare($check_sql);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->execute();
        ...
        $insert_sql = "INSERT INTO " . "qwq_favorite 
    ...
    public function deleteFavorite($user_id, $vod_id) {
        ...
        // 删除收藏
        $delete_sql = "DELETE FROM " . "qwq_favorite WHERE user_id = :user_id AND vod_id = :vod_id";
    ...
    public function addHistory($user_id, $params) {
        ...
        // 检查是否已有历史记录
        $check_sql = "SELECT COUNT(*) FROM " . "qwq_history WHERE user_id = :user_id AND vod_id = :vod_id";
        $stmt = $this->db->prepare($check_sql);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->execute();
        ...
        if ($stmt->fetchColumn() > 0) {
            ...
            // 查询历史记录ID
            $query_sql = "SELECT history_id FROM " . "qwq_history WHERE user_id = :user_id AND vod_id = :vod_id";
            ...
            // 添加历史记录
            $insert_sql = "INSERT INTO " . "qwq_history 
    ...
    public function deleteHistory($user_id, $vod_id) {
        ...
        // 删除历史记录
        $delete_sql = "DELETE FROM " . "qwq_history WHERE user_id = :user_id AND vod_id = :vod_id";
        $stmt = $this->db->prepare($delete_sql);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->execute();
    ...
    public function deleteAllHistory($user_id) {
        // 检查是否有历史记录
        $check_sql = "SELECT COUNT(*) FROM " . "qwq_history WHERE user_id = :user_id";
        $stmt = $this->db->prepare($check_sql);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->execute();
        if ($stmt->fetchColumn() == 0) {
        ...
        // 删除全部历史记录
        $delete_sql = "DELETE FROM " . "qwq_history WHERE user_id = :user_id";
        $stmt = $this->db->prepare($delete_sql);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->execute();
        response_success(null);
    ...
    public function likeVod($user_id, $params) {
        ...
        // 查询是否已有点赞记录
        $check_like_sql = "SELECT zan FROM qwq_like WHERE vod_id = :vod_id AND user_id = :user_id";
        ...
        try {
            ...
            if ($like) {
                // 已有记录，更新zan
                $update_like_sql = "UPDATE qwq_like SET zan = :zan WHERE vod_id = :vod_id AND user_id = :user_id";
                ...
                // 新增点赞记录
                $insert_like_sql = "INSERT INTO qwq_like (vod_id, user_id, zan) VALUES (:vod_id, :user_id, :zan)";
            ...
            $this->db->commit();
            // 再查一次数据库当前zan状态
            $stmt = $this->db->prepare("SELECT zan FROM qwq_like WHERE vod_id = :vod_id AND user_id = :user_id");
            $stmt->bindParam(':vod_id', $vod_id);
            $stmt->bindParam(':user_id', $user_id);
            $stmt->execute();
    ...
    public function isLiked($user_id, $params) {
        ...
        $vod_id = intval($params['vod_id']);
        $sql = "SELECT zan FROM qwq_like WHERE vod_id = :vod_id AND user_id = :user_id";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->execute();
    ...
    public function isFavorite($user_id, $params) {
        ...
        $vod_id = intval($params['vod_id']);
        $sql = "SELECT COUNT(*) FROM " . "qwq_favorite WHERE user_id = :user_id AND vod_id = :vod_id";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->execute();
    ...
    public function sendDanmaku($user_id, $params) {
        ...
        // 插入弹幕
        $insert_sql = "INSERT INTO qwq_danmaku (vod_id, episode_index, user_id, content, color, position, time, create_time) VALUES (:vod_id, :episode_index, :user_id, :content, :color, :position, :time, NOW())";
        $stmt = $this->db->prepare($insert_sql);
        $stmt->bindParam(':vod_id', $vod_id);
    ...
    public function getDanmaku($params) {
        ...
        $vod_id = intval($params['vod_id']);
        $episode_index = isset($params['episode_index']) ? intval($params['episode_index']) : 0;
        $sql = "SELECT time, position, color, content FROM qwq_danmaku WHERE vod_id = :vod_id AND episode_index = :episode_index ORDER BY time ASC";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->bindParam(':episode_index', $episode_index);
        $stmt->execute();
        ...
        // 查询弹幕数量
        $count_sql = "SELECT COUNT(*) FROM qwq_danmaku WHERE vod_id = :vod_id AND episode_index = :episode_index";
        $stmt = $this->db->prepare($count_sql);
        $stmt->bindParam(':vod_id', $vod_id);
        $stmt->bindParam(':episode_index', $episode_index);
        $stmt->execute();
