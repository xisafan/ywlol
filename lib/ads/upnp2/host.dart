...
main() async {
  final device = UpnpHostDevice(
      ...
      udn:
          'uuid:9a3b452a33cd4218e755c5b14f9c13ac57f5c2af754b2a9c0c3ff5919740c18e');
  ...
  helloService.actions.add(
      UpnpHostAction('HelloWorld', handler: (params) => print('Hello World')));
  ...
  final discovery =
      UpnpDiscoveryServer(device, 'http://192.168.1.2:4021/upnp/root.xml');
