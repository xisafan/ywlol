...
class ResetPasswordController {
    ...
    public function sendVerificationCode($params) {
        ...
        // 检查邮箱是否存在
        $check_sql = "SELECT user_id, username FROM " . DB_PREFIX . "ovo_user WHERE email = :email AND status = 1";
        ...
        try {
            // 检查是否已有验证码记录
            $check_code_sql = "SELECT id FROM " . DB_PREFIX . "ovo_verification_code WHERE email = :email AND type = 'reset_password'";
    ...
    public function resetPassword($params) {
        ...
        try {
            ...
            // 更新OVO用户表密码
            $update_sql = "UPDATE " . DB_PREFIX . "ovo_user 
            ...
            // 删除验证码记录
            $delete_sql = "DELETE FROM " . DB_PREFIX . "ovo_verification_code 
                WHERE id = :id";
